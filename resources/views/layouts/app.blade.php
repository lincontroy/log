            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="/home" aria-expanded="false" aria-controls="sidebarDashboards">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#cards" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="cards">
                                <i class="ri-apps-2-line"></i> <span data-key="t-apps">Cards</span>
                            </a>
                            ...
                            <!-- Loop through to see the bank logs -->
                                    ...
                                    <li class="nav-item">
                                        <a href="{{url('buycard')}}/1" class="nav-link" data-key="t-calendar"> Visa
                                    </a>
                                    </li>

                                    
                                    <li class="nav-item">
                                        <a href="{{url('buycard')}}/2" class="nav-link" data-key="t-calendar"> Mastercard
                                    </a>
                                    </li>

                                    
                                    <li class="nav-item">
                                        <a href="{{url('buycard')}}/3" class="nav-link" data-key="t-calendar"> American express
                                    </a>
                                    </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#Accounts" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="Accounts">
                                <i class="ri-apps-2-line"></i> <span data-key="t-apps">Accounts</span>
                            </a>
                            ...
                            <!-- Loop through to see the bank logs -->
                                    ...
                                    <li class="nav-item">
                                        <a href="{{url('buyaccount')}}/1" class="nav-link" data-key="t-calendar"> Cashapp
                                    </a>
                                    </li>

                                    
                                    <li class="nav-item">
                                        <a href="{{url('buyaccount')}}/2" class="nav-link" data-key="t-calendar"> Paypal
                                    </a>
                                    </li>

                                    
                                    <li class="nav-item">
                                        <a href="{{url('buyaccount')}}/3" class="nav-link" data-key="t-calendar"> Shop with scrip logs
                                    </a>
                                    </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#dumps" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="dumps">
                                <i class="ri-apps-2-line"></i> <span data-key="t-apps">CC Dumps with bin</span>
                            </a>
                            <div class="collapse menu-dropdown" id="dumps">
                                <ul class="nav nav-sm flex-column">
                            ...
                            <!-- Loop through to see the bank logs -->
                                    ...
                                    <li class="nav-item">
                                        <a href="{{url('buydumps')}}/1" class="nav-link" data-key="t-calendar">CVW1
                                    </a>
                                    </li>

                                    
                                    <li class="nav-item">
                                        <a href="{{url('buydumps')}}/2" class="nav-link" data-key="t-calendar">CVW2
                                    </a>
                                    </li>

                                    
                                    <li class="nav-item">
                                        <a href="{{url('buydumps')}}/3" class="nav-link" data-key="t-calendar">Dumps1
                                    </a>
                                    </li>
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link menu-link" href="{{url('deposit')}}" >
                                <i class="ri-apps-2-line"></i> Deposit
                            </a>
