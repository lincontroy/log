...
class DepositsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //insert this information in the deposits table

        $insert=Deposits::create(['amount'=>$amount,'user_id'=>$user]);

        if($insert){


            toastr()->success('Deposit request received! awaiting approval!');
